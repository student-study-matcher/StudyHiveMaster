...
class _EditProfileState extends State<EditChat> {
  Uint8List? _image;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  " This name will be visible to the other participants.",
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      // Handle logic for "Show All" button
                    },
                  ...
                  ElevatedButton(
                    onPressed: () {
                      // Handle logic for "Add New" button
                    },
                    style: ElevatedButton.styleFrom(
